        ...
        <div className="relative w-full h-[45vh] min-h-[280px] max-h-[520px] overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="mx-auto max-w-7xl px-6 pb-10 w-full">
              <span className="inline-flex items-center gap-2 rounded-full border border-primary/40 bg-background/50 px-4 py-1.5 text-xs uppercase tracking-widest text-brand-orange">
