...
- supplier_name: identifique a OPERADORA/FORNECEDOR emissor do orçamento. VARRA O DOCUMENTO INTEIRO (cabeçalho, rodapé, marca d'água E CORPO DO TEXTO, incluindo termos, cláusulas, descrições de produtos como Protec Travel/seguros/flexibilidade) — não olhe só o topo. AGÊNCIAS REVENDEDORAS NUNCA SÃO A OPERADORA: "VIA AIR", "Voe Air", "voeair", e qualquer nome que apareça só como identidade do revendedor devem ser IGNORADOS mesmo quando estampados grandes no topo/rodapé. Plataformas técnicas também não contam: "Infotera", "Powered by Infotera", "Lets", "Hotelbeds" (quando aparecer como marketplace). Sempre prefira o nome que aparecer como OPERADORA/EMISSOR do produto. Regras de marca: "Visual" (losango azul) → "Visual Turismo"; "CVC" → "CVC"; "Azul Viagens" → "Azul Viagens"; "Flytour" → "Flytour"; "Nascimento" → "Nascimento Turismo"; qualquer menção a "Cativa" ou "Cativa Operadora" (mesmo se aparecer apenas dentro do texto de Protec Travel / cláusulas / rodapé fino) → "Cativa Operadora"; "GTA" → "GTA"; "HubTravels" → "HubTravels". Se realmente não encontrar operadora identificável, deixe supplier_name em branco (""), NUNCA use o nome da agência revendedora.
