...
Devolva APENAS um JSON válido (sem markdown) nesta forma exata (omita campos que não estiverem no documento — NÃO invente):
{
  ...
  "room_type": "Standard | Superior | Luxo | ... (NUNCA incluir termos comerciais do broker/fornecedor como 'Frete', 'Broker', 'Tarifa', 'Net', 'Pacote', 'Contratada')",
  "room_category": "Standard (só a categoria — remova 'Frete', 'Broker', 'Tarifa', 'Net', 'Pacote', 'Contratada' se aparecerem)",
