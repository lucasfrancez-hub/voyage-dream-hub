...
.page{width:1024px;min-height:1448px;margin:24px auto;background:#fff;padding:32px 54px 22px;box-shadow:0 10px 35px rgba(10,38,66,.12)}
...
h1{margin:12px 0 6px;font-size:28px;letter-spacing:-.8px;color:var(--navy)}
...
.grid2{display:grid;grid-template-columns:1fr 1.05fr;gap:34px;margin-top:16px}
.section-title{display:flex;align-items:center;gap:9px;font-size:18px;font-weight:800;color:var(--navy);margin-bottom:10px}
.ico{flex:none;display:block}
.card{border:1px solid #edf0f3;border-radius:20px;padding:16px 20px;box-shadow:0 6px 18px rgba(12,39,68,.06);background:#fff}
.payer .row{display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid #e5e9ed;font-size:15px}
.payer .row:last-child{border:0}
.payer .row .sep{width:1px;height:16px;background:#e5e9ed;margin:0 6px}
.pix-top{display:grid;grid-template-columns:150px 1fr;gap:16px;align-items:start}
...
.copytitle{display:flex;align-items:center;gap:8px;font-size:14px;font-weight:700;margin:12px 0 6px}
...
.comp-left{padding:16px 22px}
.comp-row{display:grid;grid-template-columns:185px 1fr;align-items:center;padding:6px 0;border-bottom:1px solid #e6eaee}
...
.comp-total{border-left:1px solid #e5e9ed;display:flex;flex-direction:column;justify-content:center;padding:18px 30px;background:linear-gradient(90deg,#fff,#fafbfd)}
.comp-total small{font-weight:700;color:var(--navy)}
.comp-total strong{margin-top:8px;font-size:27px;color:var(--navy)}
