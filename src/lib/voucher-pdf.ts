...
const L = {
  pt: {
    ...
    cafeManha: "CAFE DA MANHA",
    cafeIncluso: "Incluso",
    cafeNaoIncluso: "Nao incluso",
  ...
  en: {
    ...
    tipoCama: "BED TYPE",
    cafeManha: "BREAKFAST",
    cafeIncluso: "Included",
    cafeNaoIncluso: "Not included",
...
export async function generateVoucher(
  ...
  const paxSetForItems = (its: OrderItem[]): Set<string> => {
    ...
    // Sem vínculo explícito → assume todos os passageiros do pedido (comum
