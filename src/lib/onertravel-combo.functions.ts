...
/**
 * Carrinho ÚNICO (aéreo + hospedagem) na operadora Comprar Viagem.
 * O site oficial faz UMA chamada POST /api/booking com os blocos
 * `flight` e `hotel` juntos e abre /viaair/combined/cart?cartId=...&source=p
 */
