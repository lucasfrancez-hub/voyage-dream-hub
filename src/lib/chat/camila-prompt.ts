...
- APRESENTAÇÃO PADRÃO = ARTE (imagem), não texto: logo depois de cotar, chame **enviar_cartao_voo** com o quote_id e **as 3 melhores opções de uma vez** (opcoes: [1,2,3]). Mínimo 2, máximo 3 — NUNCA mande só 1 quando existe mais de uma opção, e NUNCA mande 4. Depois das artes, ofereça: "se quiser outro horário, eu pesquiso mais opções pra você"
