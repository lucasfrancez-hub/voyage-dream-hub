...
.stage .state{margin-top:38px;display:inline-flex;align-items:center;gap:12px;width:max-content;padding:10px 20px;border:2px solid #ff8a1f;border-radius:999px;color:#ff8a1f;font-weight:800;font-size:28px;letter-spacing:.5px;background:rgba(0,20,28,.35);isolation:isolate;overflow:hidden;backdrop-filter:blur(12px) saturate(120%);-webkit-backdrop-filter:blur(12px) saturate(120%)}
...
.stage .glass{position:relative;isolation:isolate;overflow:hidden;border:1px solid rgba(255,255,255,.48);box-shadow:inset 0 1px 0 rgba(255,255,255,.18),0 12px 35px rgba(0,0,0,.16);backdrop-filter:blur(18px) saturate(125%);-webkit-backdrop-filter:blur(18px) saturate(125%)}
.stage .glass.light{background:rgba(205,225,238,.28)}
.stage .glass.dark{background:rgba(2,18,28,.78);border:1px solid rgba(255,255,255,.22);box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 14px 38px rgba(0,0,0,.28);backdrop-filter:blur(20px) saturate(120%);-webkit-backdrop-filter:blur(20px) saturate(120%)}
...
.stage .info-item{display:grid;grid-template-columns:54px 1fr;gap:16px;align-items:center;padding:0 18px;min-height:120px;text-align:left}
.stage .info-item+.info-item{border-left:2px solid #ff8a1f}
.stage .info-item>div{min-width:0;text-align:left}
.stage .icon{width:48px;height:48px;stroke:#fff;stroke-width:2;fill:none;stroke-linecap:round;stroke-linejoin:round;flex-shrink:0}
.stage .info strong{display:block;font-size:29px;line-height:1.12;font-weight:800}
...
.stage .include{min-width:135px;max-width:170px;min-height:126px;padding:12px 20px;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;gap:8px;font-size:20px;line-height:1.08;font-weight:600}
...
.stage .price{border-radius:28px;padding:28px 30px 26px;text-align:left}
.stage .kicker{font-size:27px;letter-spacing:1px;font-weight:700}
.stage .price-row{display:flex;align-items:flex-end;gap:12px;margin:10px 0 4px;justify-content:flex-start}
...
.stage .total{font-size:26px;border-top:2px solid #ff8a1f;border-bottom:2px solid #ff8a1f;padding:13px 0;margin-top:18px;text-align:left}
.stage .total strong{color:#ff8a1f}
.stage .payment{margin-top:18px;display:flex;align-items:center;gap:16px;font-size:25px;line-height:1.22;text-align:left}
...
.stage .side-card{border-radius:24px;padding:23px 24px;display:grid;grid-template-columns:58px 1fr;gap:15px;align-items:center;font-size:24px;line-height:1.25;min-height:126px;text-align:left}
