...
const body = { ...base, routes:[{origin:"GRU",destination:"MIA",date:"2026-10-10"},{origin:"MIA",destination:"JFK",date:"2026-10-15"},{origin:"JFK",destination:"GRU",date:"2026-10-20"}] };
