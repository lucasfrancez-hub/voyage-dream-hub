...
const corpo = (guid: string|null) => ({AgenciaId:Number(ses.agenciaId??0),Guid:guid,Adt:2,Chd:0,Snr:0,IdadesAdt:[18,18],IdadesChd:[],DestinoCodigo:"BR",Partida:"2026-09-20",Retorno:"2026-09-25",EscreveLog:false});
...
console.log(JSON.stringify(items[0],null,1).slice(0,4000));
